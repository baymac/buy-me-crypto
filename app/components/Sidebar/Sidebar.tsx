    ...
    return (
        <div className={styles.sidebarContainer}>
            <div className={styles.userInfo}>
                <img className={styles.userInfo__img} src={session.user.image} alt='user avatar' />
                    ...
                    return(
                        <Link href={`${item.path}`} key={item.label}>
                            ...
                            className={cn(styles.sidebarList__item, {
                                [styles.sidebarList__item_selected]: selectedMenu === `${item.selector}`,
                            })}
                            tabIndex={0}
                            >
                                <span className={styles.sidebarList__item__link} id={`${item.selector}`}>
                                    {createElement(
                                        item.icon,
