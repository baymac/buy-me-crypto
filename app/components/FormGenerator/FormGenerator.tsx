import React,{createElement, useState , ReactElement, Children} from 'react'
...
const FromGenerator = ( {formInfo , handleOnSubmit,children , handleSubmit ,errors ,register ,submitBtnText} : IFormGeneratorProps  ) => {
